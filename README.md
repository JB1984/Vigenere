...
<b>The first keyword</b>, which creates the alphabet "top" line of the matrix. This currently must contain only one instance of each letter of the alphabet. For example you can use "Hi" but not "Hello" since "Hello" has two l's. 
